...
#include "output/sparcli_panel.h"        // IWYU pragma: export
#include "output/sparcli_table.h"        // IWYU pragma: export
#include "output/sparcli_rule.h"         // IWYU pragma: export
#include "output/sparcli_list.h"         // IWYU pragma: export
