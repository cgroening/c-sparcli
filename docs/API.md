...
especially in `ScColumnsOpts.sep.color`, `ScRuleOpts.color`, etc.
...
**Zero-init pitfall:** `sep.color` defaults to `SC_ANSI_COLOR_BLACK`. Always
set `.sep.color = SC_ANSI_COLOR_NONE` when using a separator without a color.
