...
void test_panels(void) {
    ...
    sc_panel_str("No border panel", (ScPanelOpts){
        ...
        .title         = { .text = "Title", .style = bold_ttl, .pos = SC_TITLE_TOP, .align = SC_ALIGN_LEFT, .pad = 1 },
        .padding       = {0, 1, 0, 1},
    ...
    sc_panel_str("Panel with padding and margin", (ScPanelOpts){
        ...
        .bg            = SC_ANSI_COLOR_NONE,
        .title         = { .text = "Info", .style = bold_ttl, .pos = SC_TITLE_TOP, .align = SC_ALIGN_CENTER, .pad = 4 },
        .padding       = {2, 4, 2, 4},
        .margin        = {1, 5, 1, 5},
        .content_align = SC_ALIGN_LEFT,
    });
    ...
    sc_panel_str("Double border", (ScPanelOpts){
        ...
        .bg            = SC_ANSI_COLOR_NONE,
        .title         = { .text = "Warning", .style = bold_ttl, .pos = SC_TITLE_BOTTOM, .align = SC_ALIGN_RIGHT, .pad = 1 },
        .padding       = {0, 2, 0, 2},
        .content_align = SC_ALIGN_LEFT,
    });
    ...
    sc_panel_str("Rounded, no title", (ScPanelOpts){
        ...
        .bg            = SC_ANSI_COLOR_NONE,
        .title         = { .pos = SC_TITLE_TOP, .align = SC_ALIGN_LEFT, .pad = 1 },
        .padding       = {0, 2, 0, 2},
        .content_align = SC_ALIGN_LEFT,
    });
    ...
    sc_panel_str("Thick border", (ScPanelOpts){
        ...
        .bg            = SC_ANSI_COLOR_NONE,
        .title         = { .text = "Thick", .style = bold_ttl, .pos = SC_TITLE_TOP, .align = SC_ALIGN_LEFT, .pad = 1 },
        .padding       = {0, 2, 0, 2},
        .content_align = SC_ALIGN_LEFT,
    });
    ...
    sc_panel_text(t, (ScPanelOpts){
        ...
        .bg            = SC_ANSI_COLOR_NONE,
        .title         = { .text = "Styled Content", .style = on_blue, .pos = SC_TITLE_TOP, .align = SC_ALIGN_LEFT, .pad = 0 },
        .padding       = {1, 2, 1, 2},
        .content_align = SC_ALIGN_LEFT,
    });
    sc_text_free(t);
    ...
    sc_panel_str("Content has a dark blue background.", (ScPanelOpts){
        ...
        .bg            = dark_blue,
        .title         = { .text = "With bg", .style = bold_on_dark_blue, .pos = SC_TITLE_TOP, .align = SC_ALIGN_LEFT, .pad = 1 },
        .padding       = {1, 2, 1, 2},
        .content_align = SC_ALIGN_LEFT,
        .full_width    = 1,
    });
    ...
    sc_panel_str("Border itself is highlighted.", (ScPanelOpts){
        ...
        .bg            = SC_ANSI_COLOR_NONE,
        .title         = { .text = "border_bg", .style = bold_ttl, .pos = SC_TITLE_TOP, .align = SC_ALIGN_CENTER, .pad = 1 },
        .content_align = SC_ALIGN_LEFT,
        .padding       = {0, 2, 0, 2},
        .full_width    = 1,
    });
    ...
    // Full-width panel, content centered
    {
        ...
        sc_panel_str(content, (ScPanelOpts){
            ...
            .bg            = SC_ANSI_COLOR_NONE,
            .title         = { .text = "Full Width", .style = bold_ttl, .pos = SC_TITLE_TOP, .align = SC_ALIGN_CENTER, .pad = 1 },
            .padding       = {0, 2, 0, 2},
    ...
    sc_panel_str("Right-aligned text.\nSecond line.", (ScPanelOpts){
        ...
        .bg            = SC_ANSI_COLOR_NONE,
        .title         = { .text = "Right-Aligned Content", .style = bold_ttl, .pos = SC_TITLE_TOP, .align = SC_ALIGN_RIGHT, .pad = 1 },
        .padding       = {0, 1, 0, 1},
