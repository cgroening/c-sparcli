...
void test_tables(void) {
    ...
    /* ── 2. Double border, header row + header col, colored separators ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Product", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Q1", (ScColOpts){
                0, 0, 0, SC_ALIGN_RIGHT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Q2", (ScColOpts){
                0, 0, 0, SC_ALIGN_RIGHT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Q3", (ScColOpts){
                0, 0, 0, SC_ALIGN_RIGHT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
            table_data, (ScCell[]){
                sc_cell("Apples"), sc_cell("120"), sc_cell("95"),  sc_cell("140"),
            },
            4
        );
        sc_table_add_row(
            table_data, (ScCell[]){
                sc_cell("Bananas"), sc_cell("80"),  sc_cell("110"), sc_cell("70"),
            },
            4
        );
        sc_table_add_row(
            table_data, (ScCell[]){
                sc_cell("Cherries"), sc_cell("45"),  sc_cell("60"),  sc_cell("90"),
            },
            4
        );
        sc_table_print(
    ...
    /* ── 3. Rounded border, striped rows ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Lang", (ScColOpts){
                0, 0, 12, SC_ALIGN_LEFT,   SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Year", (ScColOpts){
                0, 0, 6,  SC_ALIGN_RIGHT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Typed", (ScColOpts){
    ...
    /* ── 4. ScText cells with mixed styles ── */
    {
        ...
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Service", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Status", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Uptime", (ScColOpts){
                0, 0, 0, SC_ALIGN_RIGHT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
            table_data, (ScCell[]){
                sc_cell_t(lbl), sc_cell_t(ok),  sc_cell("99.9%"),
            },
            3
        );
        sc_table_add_row(
    ...
    /* ── 5. Column alignment: left / center / right ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Left", (ScColOpts){
                0, 0, 14, SC_ALIGN_LEFT,   SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Center", (ScColOpts){
                0, 0, 14, SC_ALIGN_CENTER, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Right", (ScColOpts){
                0, 0, 14, SC_ALIGN_RIGHT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
            table_data, (ScCell[]){
    ...
    /* ── 6. Vertical alignment: top / middle / bottom ── */
    {
        ...
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Tall Cell", (ScColOpts){
                0, 0, 0,  SC_ALIGN_LEFT, SC_VALIGN_TOP,    0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Top", (ScColOpts){
                0, 0, 10, SC_ALIGN_LEFT, SC_VALIGN_TOP,    0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Middle", (ScColOpts){
                0, 0, 10, SC_ALIGN_LEFT, SC_VALIGN_MIDDLE, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Bottom", (ScColOpts){
                0, 0, 10, SC_ALIGN_LEFT, SC_VALIGN_BOTTOM, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
            table_data, (ScCell[]){
    ...
    /* ── 7. Fixed / min / max column widths ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Fixed=16", (ScColOpts){
                0,  0, 16, SC_ALIGN_LEFT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Min=10", (ScColOpts){
                10, 0, 0,  SC_ALIGN_LEFT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Max=8", (ScColOpts){
                0,  8, 0,  SC_ALIGN_RIGHT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Auto", (ScColOpts){
                0,  0, 0,  SC_ALIGN_LEFT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
    ...
    /* ── 8. No border ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Animal", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Sound", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Legs", (ScColOpts){
                0, 0, 0, SC_ALIGN_RIGHT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
    ...
    /* ── 9. ASCII border ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Key", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Value", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
    ...
    /* ── 10. Thick border, golden color ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "OS", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT,   SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Kernel", (ScColOpts){
                0, 0, 0, SC_ALIGN_CENTER, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Shell", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT,   SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
        ...
        sc_table_print(
            table_data, (ScTableOpts){
                .border = {
                    SC_BORDER_THICK,
                    sc_ansi_color_from_rgb(255, 180, 0),
                    SC_ANSI_COLOR_NONE,
                    SC_ANSI_COLOR_NONE,
                    SC_ANSI_COLOR_NONE,
                    0, 0, 0
    ...
    /* ── 11. Word wrap ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Component", (ScColOpts){
                0, 0, 14, SC_ALIGN_LEFT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Description", (ScColOpts){
                0, 0, 24, SC_ALIGN_LEFT, SC_VALIGN_TOP, 1, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Status", (ScColOpts){
                0, 0, 10, SC_ALIGN_CENTER, SC_VALIGN_MIDDLE, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
            table_data, (ScCell[]){
                sc_cell("Auth Service"),
                sc_cell("Handles OAuth2 token validation and refresh for all "
                        "API clients"),
                sc_cell("OK"),
            },
            3
        ...
        sc_table_add_row(
            table_data, (ScCell[]){
                ...
                sc_cell("Ingests streaming events from Kafka and writes to the "
                        "data warehouse"),
                sc_cell("WARN"),
            },
            3
        ...
        sc_table_add_row(
            table_data, (ScCell[]){
                sc_cell("Scheduler"),
                sc_cell("Runs periodic jobs using a distributed cron-like "
                        "mechanism"),
                sc_cell("OK"),
            },
            3
    ...
    /* ── 18. Footer row ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Item", (ScColOpts){
                0, 0, 0,  SC_ALIGN_LEFT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Qty", (ScColOpts){
                0, 0, 6,  SC_ALIGN_RIGHT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Price", (ScColOpts){
                0, 0, 9,  SC_ALIGN_RIGHT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Total", (ScColOpts){
                0, 0, 10, SC_ALIGN_RIGHT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
            table_data, (ScCell[]){
    ...
    /* ── 19. Per-row background ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Build", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT,   SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Branch", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT,   SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Result", (ScColOpts){
                0, 0, 0, SC_ALIGN_CENTER, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Time", (ScColOpts){
                0, 0, 0, SC_ALIGN_RIGHT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
    ...
    /* ── 20. Per-column background ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Feature", (ScColOpts){
                0, 0, 18, SC_ALIGN_LEFT,   SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Free", (ScColOpts){
                0, 0, 10, SC_ALIGN_CENTER, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Pro", (ScColOpts){
                0, 0, 10,
                SC_ALIGN_CENTER, SC_VALIGN_TOP, 0,
                sc_ansi_color_from_rgb(20, 45, 90)
            }
        );
        sc_table_add_column(
            table_data, "Enterprise", (ScColOpts){
                0, 0, 12, SC_ALIGN_CENTER, SC_VALIGN_TOP, 0,
                sc_ansi_color_from_rgb(60, 40, 0)
            }
        );
        sc_table_add_row(
            table_data, (ScCell[]){
        ...
        sc_table_print(
            table_data, (ScTableOpts){
                ...
                .header.row    = 1,
                .header.row_bg = sc_ansi_color_from_rgb(30, 30, 50),
                .header.opts   = {
                    SC_TEXT_ATTR_BOLD,
    ...
    /* ── 21. Total width ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Country", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Capital", (ScColOpts){
                0, 0, 0, SC_ALIGN_LEFT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Population", (ScColOpts){
                0, 0, 0, SC_ALIGN_RIGHT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
    ...
    /* ── 23. Rowspan ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Category", (ScColOpts){
                0, 0, 12, SC_ALIGN_LEFT,  SC_VALIGN_MIDDLE, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Item", (ScColOpts){
    ...
    /* ── 24. RTL column order ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "Col A", (ScColOpts){
                0, 0, 10, SC_ALIGN_LEFT,   SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Col B", (ScColOpts){
                0, 0, 10, SC_ALIGN_CENTER, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Col C", (ScColOpts){
                0, 0, 10, SC_ALIGN_RIGHT,  SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_row(
    ...
    /* ── 25. Max rows ── */
    {
        ScTableData *table_data = sc_table_new();
        sc_table_add_column(
            table_data, "#", (ScColOpts){
                0, 0, 4,  SC_ALIGN_RIGHT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        sc_table_add_column(
            table_data, "Name", (ScColOpts){
        ...
        sc_table_add_column(
            table_data, "Score", (ScColOpts){
                0, 0, 7,  SC_ALIGN_RIGHT, SC_VALIGN_TOP, 0, SC_ANSI_COLOR_NONE
            }
        );
        // Strings must outlive sc_table_print;
        // use per-row arrays rather than loop-local buffers. */
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            snprintf(
                row_score[i-1], sizeof(row_score[i-1]), "%d", 10000 - i * 850
            );
            sc_table_add_row(
                table_data, (ScCell[]){
                    sc_cell(row_idx[i-1]),
